...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
                <a class="navbar-brand" href="#"><img src="../img/canetacima.png" width="20%" height="20%" title="Caneta Azul" ></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="canetas.php">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <section>
        <br/><br/>
        <center><h1>Adicionar Musicas</h1></center>
        <br/>
    ...
    <footer class="container-fluid py-5 d-lg-block">
      <div class="row row-cols-lg-3 row-cols-md-1 row-cols-sm-1 rodape">
        <figure class="logo d-none d-lg-block ">
          <img src="../img/caneta.jpg" width="100" class="d-none d-md-block" >
        </figure>

        <h6 class="fs-5">Esse site foi feito por Pedro Henrique</h6>
